...
import BussinessHeaderImage from '../../component/BussinessHeaderImage/BussinessHeaderImage'
...
const BussinessUnit = () => {
  ...
  useEffect(() => {
    ...
    divElements.forEach((div, index) => {
            div.setAttribute('data-bussiness-unit', `.bussiness-unit-page-app-react${index}`);
